...
def mgmt_data():
    return ({'number_of_females_1': 3,
             ...
             'number_of_initial_vacancies_2': 0,
             'number_of_initial_vacancies_3': 0,
             'hiring_rate_women_1': 0.167,
             'hiring_rate_women_2': 0.167,
             'hiring_rate_women_3': 0.167,
             'hiring_rate_men_1': 0.167,
             'hiring_rate_men_2': 0.167,
             'hiring_rate_men_3': 0.167,
...
def mgmt_growth_data():
    return ({'number_of_females_1': 3,
             ...
             'variation_range': 3,
             'duration': 20,
             'growth_rate': [0.00, 0.00, 0.0, 0.0, 0.0]})
